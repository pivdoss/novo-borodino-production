...
const cookieBody = `
  ...
  <main id="content" class="cookie-page"><section class="lot-section"><div class="lot-container cookie-page__content"><p class="lot-kicker">Cookie и аналитика</p><h1>Настройки<br><em>аналитики.</em></h1><p>На сайте нет форм для имени, телефона или e-mail, и здесь не хранятся контактные заявки. Для связи с Екатериной посетитель самостоятельно выбирает звонок или мессенджер. Если на опубликованной версии будет включена Яндекс Метрика, она начнёт работать только после вашего согласия.</p><h2>Что может использоваться</h2><p>Технические параметры посещения, обезличенные сведения о просмотре страниц и кликах, а также cookie аналитики Яндекс Метрики. Это помогает оценивать интерес к странице и улучшать её содержание.</p><h2>Ваш выбор</h2><p>Вы можете принять или отклонить аналитические cookie в появившейся плашке, а затем изменить решение внизу любой страницы.</p><a class="lot-button lot-button--dark" href="/">Вернуться к лендингу</a></div></section></main>
