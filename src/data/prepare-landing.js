...
const markerReplacements = Object.freeze([
  ['01 / Состав предложения', `<span class="chapter-kicker">${chapters.asset}</span>`],
  ['02 / Схема массива', `<span class="chapter-kicker">${chapters.concept}</span>`],
  ['Территория с высоты', `<span class="chapter-kicker">${chapters.territory}</span>`],
  ['03 / Юридическая готовность', `<span class="chapter-kicker">${chapters.facts}</span>`],
  ['Для предметного разговора', `<span class="chapter-kicker">${chapters.materials}</span>`],
  ['05 / Возможный сценарий', `<span class="chapter-kicker">${chapters.visualizations}</span>`],
  ['07 / Локация', `<span class="chapter-kicker">${chapters.location}</span>`],
  ['08 / Территория сегодня', `<span class="chapter-kicker">${chapters.actual}</span>`],
  ['Перед первым разговором', `<span class="chapter-kicker">${chapters.questions}</span>`],
  ['09 / Личный контакт', `<span class="chapter-kicker">${chapters.contacts}</span>`],
]);
