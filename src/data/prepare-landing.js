...
export const prepareLandingMarkup = (markup) => markerReplacements
  ...
  .replace('В одном предложении объединены 71 участок площадью 5,2 га и 1 га внутренних дорог. Массив продаётся целиком одним лотом.', 'В одном предложении объединены 71 участок площадью 5,2 га и 1 га внутренних дорог. <strong class="copy-accent">Массив продаётся целиком одним лотом.</strong>')
  .replace('По объекту подготовлен комплект подтверждающих материалов: реестр 71 участка, актуальные выписки, документы на внутренние дороги, сведения об электроснабжении, согласования Минкультуры и материалы археологических работ.', '<strong class="copy-accent">По объекту подготовлен комплект подтверждающих материалов:</strong> реестр 71 участка, актуальные выписки, документы на внутренние дороги, сведения об электроснабжении, согласования Минкультуры и материалы археологических работ.')
  .replace('Получите документы и исходные данные по объекту до разговора о просмотре и условиях сделки.', '<strong class="copy-accent copy-accent--materials">Получите документы</strong> и исходные данные по объекту до разговора о просмотре и условиях сделки.')
  .replace('71 участок общей площадью 5,2 га и 1 га внутренних дорог образуют единый продаваемый актив. Площадь участков — от 5 до 10 соток. Продаваемая территория на схеме выделена красным контуром.', '<strong class="copy-accent">71 участок</strong> общей площадью <strong class="copy-accent">5,2 га</strong> и 1 га внутренних дорог образуют единый продаваемый актив. <strong class="copy-accent">Площадь участков — от 5 до 10 соток.</strong> Продаваемая территория на схеме выделена красным контуром.')
