...
export const prepareLandingMarkup = (markup) => markerReplacements
  ...
  .replace('Получите документы и исходные данные по объекту до разговора о просмотре и условиях сделки.', '<strong class="copy-accent">Получите документы</strong> и исходные данные по объекту до разговора о просмотре и условиях сделки.')
